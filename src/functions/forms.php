 ...
 */
function tsm_handle_newsletter_signup_ajax() {
	// Verify nonce
	if ( ! isset( $_POST['nonce'] ) || ! wp_verify_nonce( $_POST['nonce'], 'tsm_newsletter_signup' ) ) {
	...
	wp_send_json_success( array( 
		'message' => __( 'Thank you for subscribing! We\'ll keep you updated with our latest news.', 'tsm-theme' ),
	) );
}
add_action( 'wp_ajax_tsm_newsletter_signup', 'tsm_handle_newsletter_signup_ajax' );
add_action( 'wp_ajax_nopriv_tsm_newsletter_signup', 'tsm_handle_newsletter_signup_ajax' );
...
/**
 * Handle decision form submission via AJAX
 */
function tsm_handle_decision_form_ajax() {
	// Verify nonce
	if ( ! isset( $_POST['nonce'] ) || ! wp_verify_nonce( $_POST['nonce'], 'tsm_decision_form' ) ) {
		wp_send_json_error( array( 'message' => 'Security check failed. Please try again.' ) );
	}
	...
	// Return success response
	wp_send_json_success( array( 
		'message' => __( 'Thank you! We\'ve received your decision and will be in touch soon.', 'tsm-theme' ),
	) );
}
add_action( 'wp_ajax_tsm_decision_form', 'tsm_handle_decision_form_ajax' );
add_action( 'wp_ajax_nopriv_tsm_decision_form', 'tsm_handle_decision_form_ajax' );
 ...
 */
function tsm_handle_contact_form_ajax() {
	// Verify nonce
	if ( ! isset( $_POST['nonce'] ) || ! wp_verify_nonce( $_POST['nonce'], 'tsm_contact_form' ) ) {
		wp_send_json_error( array( 'message' => 'Security check failed. Please try again.' ) );
	}
	...
	// Return success response
	wp_send_json_success( array( 
		'message' => __( 'Thank you for contacting us! We\'ll get back to you soon.', 'tsm-theme' ),
	) );
}
add_action( 'wp_ajax_tsm_contact_form', 'tsm_handle_contact_form_ajax' );
add_action( 'wp_ajax_nopriv_tsm_contact_form', 'tsm_handle_contact_form_ajax' );
...
/**
 * Handle prayer request form submission via AJAX
 */
function tsm_handle_prayer_request_ajax() {
	// Verify nonce
	if ( ! isset( $_POST['nonce'] ) || ! wp_verify_nonce( $_POST['nonce'], 'tsm_prayer_request' ) ) {
		wp_send_json_error( array( 'message' => 'Security check failed. Please try again.' ) );
	}
	...
	// Return success response
	wp_send_json_success( array( 
		'message' => __( 'Thank you for sharing your prayer request. We\'ll be praying for you!', 'tsm-theme' ),
	) );
}
add_action( 'wp_ajax_tsm_prayer_request', 'tsm_handle_prayer_request_ajax' );
add_action( 'wp_ajax_nopriv_tsm_prayer_request', 'tsm_handle_prayer_request_ajax' );
...
/**
 * Handle partner form submission via AJAX
 */
function tsm_handle_partner_form_ajax() {
	// Verify nonce
	if ( ! isset( $_POST['nonce'] ) || ! wp_verify_nonce( $_POST['nonce'], 'tsm_partner_form' ) ) {
		wp_send_json_error( array( 'message' => 'Security check failed. Please try again.' ) );
	}
	...
	// Return success response
	wp_send_json_success( array( 
		'message' => __( 'We\'ve received your partnership inquiry and will be in touch soon.', 'tsm-theme' ),
		'has_account_details' => $has_account_details,
	) );
}
add_action( 'wp_ajax_tsm_partner_form', 'tsm_handle_partner_form_ajax' );
add_action( 'wp_ajax_nopriv_tsm_partner_form', 'tsm_handle_partner_form_ajax' );
